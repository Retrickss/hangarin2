...
SECRET_KEY = 'django-insecure-bo^)p#=i=p-gz*d1@o&o1m@*)q6wtw+(_ut0s)6y=nd#f_7ba*'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', 'localhost','hangarin2.pythonanywhere.com']
